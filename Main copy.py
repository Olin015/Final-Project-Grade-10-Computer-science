...
while full_game:  #loop to allow the full game to repeat
    ...
    stans_text11 = stans_font.render(f"then they need to beacuse they are evil. You must",1,'yellow')
    stans_text12 = stans_font.render(f"protect the apples your kids are in by hitting the  ",1,'yellow')
    stans_text13 = stans_font.render(f"snakes with metal pipes. The way the apple turn ",1,'yellow')
